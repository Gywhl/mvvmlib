...
public final class DefaultErrorActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        saveErrorFile(CustomActivityOnCrash.getAllErrorDetailsFromIntent(DefaultErrorActivity.this, getIntent()));
     ...
     */
    public void saveErrorFile(String errorInfo) {
        File file = new File(ERROR + TimeUtils.getStrCurrentTime("") + ".txt");
        ...
        try {
            ...
            outputStream.write(errorInfo.getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
            try {
