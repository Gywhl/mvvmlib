...
public class TextFontUtils {
     ...
     * @param endColor   终止颜色
     */
    public static void setGradientFont(TextView textView, int x0, int y0,int x1, int y1,int startColor, int endColor) {
        // Shader.TileMode.CLAMP：如果着色器超出原始边界范围，会复制边缘颜色
        LinearGradient gradient = new LinearGradient(x0, y0, x1,
                y1,
                startColor, endColor,
